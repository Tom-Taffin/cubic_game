...
class Level2_stage3(Level):
    ...
    def __init__(self, width:int, height:int):
        ...
        for i in range(100,width,100):
            ennemies.append(Ennemy_laser_pulsation(i,0,i,height,3,40,120))
            ennemies.append(Ennemy_laser_pulsation(0,i,width,i,3,40,120))
        for i in range(50,width,100):
            ennemies.append(Ennemy_laser_pulsation(i,0,i,height,3,40,120,80))
            ennemies.append(Ennemy_laser_pulsation(0,i,width,i,3,40,120,80))
